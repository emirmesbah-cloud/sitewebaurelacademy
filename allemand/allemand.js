...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      'hero.proof': '📚 École spécialisée en allemand',
      ...
      'solution.after.li1': '✅ Niveau B2 préparé pour les examens (Goethe / TestDaF / telc)',
      'solution.after.li2': '✅ Tu écris CV + Anschreiben en allemand',
      'solution.after.li3': '✅ Tu passes un entretien en allemand',
      'solution.after.li4': "✅ Méthode pour structurer ton dossier (Ausbildung / études / autre)",
      'solution.after.li5': "✅ Communauté d'apprenants actifs pour s'entraîner",
      ...
      'prog.bonus.l1': '📱 Communauté Telegram privée entre apprenants Aurel',
      ...
      'tier.prem.li5': '<strong>Communauté privée</strong> entre apprenants Aurel',
      ...
      'story.title.suffix': ' ?',
      'story.lead': 'Une formation linguistique sérieuse, conçue pour réussir.',
      ...
      'why.f4.desc': "Plateforme dédiée accessible 24/7 depuis n'importe quel appareil. Pas de déplacement, pas d'horaires imposés (sauf live hebdomadaires).",
      'why.f5.title': 'Outils pédagogiques',
      'why.f5.desc': "Templates de CV en allemand, modèles de lettres de motivation (Anschreiben), guide Anerkennung trilingue, fiches de mémorisation.",
      'why.f6.title': "Communauté d'apprentissage",
      'why.f6.desc': "Groupe Telegram privé entre apprenants pour s'entraider, partager les ressources, pratiquer ensemble.",
    ...
    ar: {
      ...
      'hero.proof': '📚 مدرسة متخصصة في تعليم الألمانية',
      ...
      'solution.after.li5': "✅ مجتمع متعلمين نشطاء للتدرّب",
      ...
      'prog.bonus.l1': '📱 مجتمع Telegram خاص بين متعلمي Aurel',
      ...
      'tier.prem.li5': '<strong>مجتمع خاص</strong> بين متعلمي Aurel',
      ...
      'story.title.accent': 'Aurel Academy',
      'story.title.suffix': ' ؟',
      'story.lead': 'تكوين لغوي جدي، مصمَّم للنجاح.',
      'why.f1.title': 'دورة منظّمة A1 → B2',
      'why.f1.desc': 'تقدم تربوي متماشٍ مع الإطار الأوروبي المرجعي للغات (CECRL)، مع تحضير لامتحانات Goethe / TestDaF / telc.',
      'why.f2.title': 'الألمانية الطبية Pflege',
      'why.f2.desc': 'برنامج مخصّص لمفردات الرعاية في Pflegeheim : 10 وحدات، 18 درساً مرئياً، 4 ساعات و30 دقيقة من المحتوى، قاموس كامل.',
      'why.f3.title': 'ثلاثي اللغات : FR — DE — Darija',
      'why.f3.desc': 'شروحات بالفرنسية، محتوى بالألمانية، قاموس طبي بالدارجة. قراءة ثلاثية لتثبيت المفردات.',
      'why.f4.title': '100% عبر الإنترنت',
      'why.f4.desc': 'منصّة مخصّصة متاحة 24/7 من أي جهاز. لا تنقّل، لا أوقات مفروضة (باستثناء الجلسات الأسبوعية المباشرة).',
      'why.f5.title': 'موارد تربوية',
      'why.f5.desc': 'نماذج CV بالألمانية، نماذج رسائل التحفيز (Anschreiben)، دليل Anerkennung ثلاثي اللغات، بطاقات الحفظ.',
      'why.f6.title': 'مجتمع تعلّم',
      'why.f6.desc': 'مجموعة Telegram خاصة بين المتعلمين للتعاون، مشاركة الموارد، التدرّب معاً.',
