...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      'hero.sub': "L'allemand médical qui te fait décrocher ton poste en Pflegeheim allemand. Programme premium pour infirmiers et aides-soignants algériens.",
      ...
      'form.tier.ac.feat.4': 'Cercle privé d\'alumni placés en Allemagne',
      ...
      'solution.title.p3': '.',
      'solution.lead': "Aurel a passé 2 ans à décrypter le marché Pflege allemand. Il a vu ce qui marche, ce qui bloque, et ce que les agences ne te disent pas. Cette formation condense tout ça en 10 modules actionnables, en français et en arabe.",
      ...
      'solution.after.li5': "✅ Cercle d'infirmiers algériens placés",
      ...
      'tier.ac.li4': '<strong>Cercle privé d\'alumni</strong> placés en Allemagne',
      ...
      'story.title.suffix': ' ?',
      'story.h3': '2 ans à décrypter le marché Pflege.',
      'story.body': "Je suis Aurel, fondateur d'Aurel Academy. J'ai commencé en tâtonnant comme la plupart des Algériens qui veulent partir en Allemagne. Deux ans plus tard, j'ai aidé 50+ personnes à décrocher un contrat en Pflegeheim. J'ai vu les agences arnaquer, les méthodes génériques échouer, et les rares profils qui réussissent. Cette formation, c'est ce que j'aurais voulu avoir quand j'ai commencé.",
      ...
      'testi.title.accent': 'fait le chemin',
      'testi.title.suffix': '.',
      'testi.1.quote': "Infirmière depuis 4 ans, la formation Pflege m'a permis de maîtriser le vocabulaire médical. J'ai signé avec un Pflegeheim à Munich.",
      'testi.1.cite.name': 'Meriem, 29 ans',
      'testi.1.cite.meta': 'Deutsch für Pflegekräfte · Pflegeheim Munich',
      ...
      'testi.2.cite.meta': 'Deutsch für Pflegekräfte · Visa Ausbildung en cours',
      'testi.3.quote': "Le 3ᵉ témoignage sera ajouté dès validation du contenu par l'étudiant concerné.",
      'testi.3.cite.name': 'À venir',
      'testi.3.cite.meta': 'Témoignage en cours de collecte',
      ...
      'faq.a2': '1 à 3 mois selon ton niveau de départ et ton temps de pratique. Les alumni les plus rapides ont décroché un contrat en 6 semaines.',
    ...
    ar: {
      ...
      'hero.title.before': 'Deutsch für ',
      'hero.title.accent': 'Pflegekräfte',
      'hero.sub': 'الألمانية الطبية التي تفتح لك أبواب العمل في دور الرعاية بألمانيا. برنامج متميز للممرضين ومساعدي التمريض الجزائريين.',
      ...
      'form.tier.ac.feat.4': 'دائرة خاصة من خرّيجين معيّنين في ألمانيا',
      ...
      'solution.title.p3': '.',
      'solution.lead': 'قضى أوريل سنتين في فك شفرة سوق Pflege الألماني. رأى ما يعمل، ما يعرقل، وما لا تخبرك به الوكالات. هذا التكوين يلخص كل ذلك في 10 وحدات عملية، بالفرنسية والعربية.',
      ...
      'solution.after.li5': '✅ دائرة من ممرضين جزائريين معيّنين',
      ...
      'tier.ac.li4': '<strong>دائرة خاصة من خرّيجين</strong> معيّنين في ألمانيا',
      ...
      'story.title.accent': 'Aurel Academy',
      'story.title.suffix': ' ؟',
      'story.h3': 'سنتان في فك شفرة سوق Pflege.',
      'story.body': 'أنا أوريل، مؤسس Aurel Academy. بدأت متحسساً مثل معظم الجزائريين الذين يريدون الذهاب إلى ألمانيا. سنتان لاحقاً، ساعدت أكثر من 50 شخصاً في الحصول على عقد في Pflegeheim. رأيت الوكالات تستغل، الأساليب العامة تفشل، والأنماط النادرة التي تنجح. هذا التكوين هو ما تمنيت لو كان بحوزتي عندما بدأت.',
      'story.stat1.value': '50+',
      ...
      'testi.title.accent': 'قطعوا الطريق',
      'testi.title.suffix': '.',
      'testi.1.quote': 'ممرضة منذ 4 سنوات، تكوين Pflege سمح لي بإتقان المفردات الطبية. وقعت مع Pflegeheim في ميونخ.',
      'testi.1.cite.name': 'مريم، 29 سنة',
      'testi.1.cite.meta': 'Deutsch für Pflegekräfte · Pflegeheim ميونخ',
      'testi.2.quote': 'الدعم الإنساني يحدث الفارق. أوريل والفريق يردون بسرعة، يفهمون واقعنا.',
      'testi.2.cite.name': 'سفيان، 24 سنة',
      'testi.2.cite.meta': 'Deutsch für Pflegekräfte · تأشيرة Ausbildung قيد المعالجة',
      'testi.3.quote': 'ستتم إضافة الشهادة الثالثة بمجرد التحقق من المحتوى من قبل الطالب المعني.',
      'testi.3.cite.name': 'قريباً',
      'testi.3.cite.meta': 'شهادة قيد الجمع',
      ...
      'faq.a2': 'من 1 إلى 3 أشهر حسب مستواك الأولي ووقت تطبيقك. أسرع الخريجين حصلوا على عقد في 6 أسابيع.',
